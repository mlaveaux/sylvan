...
} sylvan_report_info[] =
{
    ...
    {2, ZDD_CLAUSE_UNION, "ZDD union" },
    {2, ZDD_CLAUSE_DISTRIBUTION, "ZDD distribution" },
    {2, ZDD_CLAUSE_INTERSECT, "ZDD intersect" },
    {2, ZDD_CLAUSE_EXPAND, "ZDD expand" },
    {2, ZDD_CLAUSE_SUBSUME, "ZDD subsume" },
    {2, ZDD_CLAUSE_SELF_SUBSUME, "ZDD ssubsume" },
    {2, ZDD_CLAUSE_COF, "ZDD cof" },
    {2, ZDD_CLAUSE_QMC, "ZDD qmc" },
